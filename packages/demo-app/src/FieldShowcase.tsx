...
import { z } from 'zod';
import { Stack, Heading, Body, Card, Button } from '@intstudio/ds';
import {
  TextField,
  EmailField,
  NumberField,
  ...
  return (
    <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
      <Stack spacing="relaxed">
        <div>
          <Heading level={1}>Field Showcase</Heading>
          <Body size="md" style={{ color: '#666', marginTop: '8px' }}>
            All 22 fields generated by God Tier Factory v2.2
          </Body>
        </div>

        <Card elevation="md" style={{ padding: '32px' }}>
          <form onSubmit={handleSubmit(onSubmit)}>
            <Stack spacing="normal">
              
              {/* SIMPLE TEXT INPUTS */}
              <Heading level={3}>Text Inputs (7)</Heading>
              ...
              <div style={{ marginTop: '24px', display: 'flex', gap: '16px' }}>
                ...
                <Button type="button" variant="secondary" onClick={() => console.log('Current values:', values)}>
                  Log Values
                </Button>
              </div>
            </Stack>
        ...
        {/* LIVE VALUES */}
        <Card elevation="sm" style={{ padding: '24px', backgroundColor: '#f9fafb' }}>
          <Heading level={4}>Live Form Values</Heading>
