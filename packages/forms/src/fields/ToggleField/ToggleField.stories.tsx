      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        <div>
          ...
          <label style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
            <input type="checkbox" role="switch" className="ds-toggle ds-toggle ds-toggle ds-toggle--sm" />
        ...
        <div>
          ...
          <label style={{ display: 'inline-flex', alignItems: 'center', gap: '0.75rem', cursor: 'pointer' }}>
            <input type="checkbox" role="switch" className="ds-toggle ds-toggle ds-toggle ds-toggle--lg" />
